    ...
    <>
      ...
      >
        ...
        <div className="testimonial-card1-testimonial">
          <span className="testimonial-card1-text body1">{props.quote}</span>
          <span className="testimonial-card1-text1 heading1">{props.name}</span>
          <span className="testimonial-card1-text2 BodySemibold">
            {props.role}
          </span>
          <img
